...
% Dados do curso
\input{dados-modelo/tipos-trabalho/utfpr-cm-ppgcc}

% Dados da disciplina ou similar. Escolha uma das opções e a descomente:
% TCC1:
...
\goal{Projeto de Trabalho de Pesquisa}
\course{} % Deixar vazio
